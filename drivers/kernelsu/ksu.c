...
// yes looks nasty
	...
	#define FEAT_14 ""
#endif
#if LINUX_VERSION_CODE < KERNEL_VERSION(3, 18, 0) && defined(KSU_HAS_BIN2HEX)
	#define FEAT_15 " +bin2hex"
#else
	#define FEAT_15 ""
#endif

#define EXTRA_FEATURES FEAT_1 FEAT_2 FEAT_3 FEAT_4 FEAT_5 FEAT_6 FEAT_7 FEAT_8 FEAT_9 FEAT_10 FEAT_11 FEAT_12 FEAT_13 FEAT_14 FEAT_15
